...
class VTUAVDataset(BaseDataset):
    ...
    def _get_sequence_list(self):
        ...
        # seqs = os.listdir('/data1/Code/luandong/WWY_code_data/Codes/sigma_fusion/ostrack_twobranch/3421')
        # seqs = [seq.replace('.txt','') for seq in seqs]
        # sequence_list = list(set(sequence_list)-set(seqs)-{'pedestrian_227','pedestrian_148','pedestrian_217'})[::-1]
