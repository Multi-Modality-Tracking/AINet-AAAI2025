...
class VisionTransformerCE(VisionTransformer):
    ...
    def forward(self, z, x, ce_template_mask=None, ce_keep_rate=None,
        ...
        #print(x_rgb.shape) # torch.Size([32, 320, 768])
        return x, aux_dict
    ...
    #     x_rgb, aux_dict_rgb = self.forward_features(z[0], x[0], ce_template_mask=ce_template_mask[0], ce_keep_rate=ce_keep_rate,)
    #     x_tir, aux_dict_tir = self.forward_features(z[1], x[1], ce_template_mask=ce_template_mask[0], ce_keep_rate=ce_keep_rate,)
        
    #     #print(x_rgb.shape) # torch.Size([32, 320, 768])
    #     x = torch.cat([x_rgb,x_tir],2)
    #     aux_dict = [aux_dict_rgb,aux_dict_tir]
