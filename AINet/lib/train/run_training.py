...
# nohup python -u run_training.py > v712.out 2>&1 &
def main():
    parser = argparse.ArgumentParser(description='Run a train scripts in train_settings.')
    parser.add_argument('--script', default='ostrack_twobranch', help='Name of the train script.')
    parser.add_argument('--config', default='vitb_256_mae_ce_32x4_ep300', help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local-rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir',default='/data1/Code/luandong/WWY_code_data/Codes/sigma_fusion/saved/v1', type=str, help='the directory to save checkpoints and logs')
