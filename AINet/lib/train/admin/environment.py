...
def create_default_local_file():
    ...
    default_settings = OrderedDict({
        ...
        'rgbt210_dir':'/data1/Datasets/Tracking/RGBT210/',
        'rgbt234_dir':'/data/RGBT234/',
        'LasHeR_dir':'/data/LasHeR/',
        'LasHeR_trainingSet_dir' : '/data/LasHeR/',
...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'lasher_trainingset_dir' : '/data/LasHeR/',
        'lasher_testingset_dir' : '/data/LasHeR/',
        'lasher_dir' : '/data/LasHeR/',
