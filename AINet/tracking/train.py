...
# nohup python -u tracking/train.py > v53.out 2>&1 &
...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='ostrack_twobranch', help='training script name')
    parser.add_argument('--config', type=str, default='vitb_256_mae_ce_32x4_ep300', help='yaml configure file name')
    parser.add_argument('--save_dir', type=str, default='/data1/Code/luandong/WWY_code_data/Codes/sigma_fusion/saved/v53', help='root directory to save checkpoints, logs, and tensorboard')
    ...
    parser.add_argument('--vis_gpus', type=str, default='0,4')
