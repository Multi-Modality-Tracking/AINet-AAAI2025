...
class EnvSettings:
    def __init__(self):
        ...
        self.result_plot_path = '{}/result_plots/'.format(test_path)
         # multi-modality
        self.rgbt210_path = '/data/RGBT210/'
        self.rgbt234_path = '/data/RGBT234/'
        self.gtot_path = '/data/GTOT/'
        self.lasher_path = '/data/LasHeR/'
        self.lashertestingset_path = '/data/LasHeR/'
