...
dataset_dict = dict(
    ...
    dmet_test = DatasetInfo(module=pt % "dmet", class_name="DMET_testingSet", kwargs=dict()),
    ...
    vtuavst=DatasetInfo(module = pt % "vtuav", class_name="VTUAVDataset", kwargs=dict()), 
    viseventtestingset=DatasetInfo(module=pt % "viseventtestingset", class_name="VisEventtestingSetDataset", kwargs=dict()),
    # depthtracktestingset=DatasetInfo(module=pt % "depthtracktestingset", class_name="DepthTracktestingSetDataset", kwargs=dict()),
